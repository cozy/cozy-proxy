...
var Client, InstanceManager, LocalStrategy, PasswordKeys, RemoteManager, StatusChecker, UserManager, bcrypt, configurePassport, express, fs, helpers, httpProxy, middlewares, passport, passwordKeys, qs, randomstring,
  ...
  */
  ...
  CozyProxy.prototype.redirectAppFilesAction = function(req, res) {
    ...
    sendRequest = function() {
      ...
      return _this.ensureStarted('files', doStart, function(err, port) {
        if (err != null) {
    ...
    req.headers['x-auth-token'] = void 0;
