...
var Client, appManager, checkLogin, clientDS, createDevice, defaultPermissions, deviceExists, deviceManager, extractCredentials, getCredentialsHeader, getProxy, initAuth, log, passport, randomString, removeDevice, updateDevice, urlHelper;
...
module.exports.dsApi = function(req, res, next) {
  var authHeader, password, ref, username;
  authHeader = req.header('authorization') || req.query.authorization;
  ref = extractCredentials(authHeader), username = ref[0], password = ref[1];
  return deviceManager.isAuthenticated(username, password, function(auth) {
    var error;
    if (auth) {
