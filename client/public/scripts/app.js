...
window.client.post = function(url, data, callbacks) {
  return $.ajax({
    ...
    dataType: "json",
    success: function(response, pouet) {
      return callbacks.success(response);
    },
    error: function(response) {
      return callbacks.error(response);
...
wait = module.exports.wait = function(time, callback) {
  return setTimeout(callback, time);
};

progFadeIn = module.exports.progFadeIn = function(objs, callback) {
  var obj;
  if (objs.length === 1) {
    obj = objs.shift();
...
progFadeOut = module.exports.progFadeOut = function(objs, callback) {
  var obj;
  if (objs.length === 1) {
    obj = objs.pop();
...
$(function() {
  ...
  onPasswordSubmitted = function() {
    ...
    return client.post("/login", {
      ...
      error: function(err) {
        ...
        return button.html(LOGIN_BUTTON_LABEL);
      }
    });
  };
  onForgotPasswordClicked = function(event) {
    return client.post("/login/forgot", {}, {
      success: function() {
        errorAlert.fadeOut();
        successAlert.fadeIn();
        return successAlert.html(RESET_SUCCESS_MESSAGE);
      },
      error: function(err) {
        var msg;
  ...
  passwordInput.focus();
  return passwordInput.select();
});
});

;require.register("register", function(exports, require, module) {
$(function() {
  var button, buttonField, buttonSeparator, emailField, emailInput, errorAlert, expandButton, handleSubmitButtonState, handleTooltip, inputFields, languageInput, localeField, passwordCheckField, passwordCheckInput, passwordField, passwordInput, publicNameField, publicNameInput, reinsurance, submitCredentials, successAlert, timezoneField, timezoneInput, validateCheckPassword, validateEmail, validatePassword;
  ...
  handleTooltip = function() {
    var firstSelector, helpSelector;
    ...
    return firstSelector.find('.help').addClass('selected');
  };
  ...
  validateEmail = function() {
    ...
    if ((email != null) && email.length > 0 && re.test(email) && email !== "") {
    ...
    return handleSubmitButtonState();
  };
  ...
  handleSubmitButtonState = function() {
    var emptyMandatoryFields, invalidFieldsNum, mandatoryFields;
    invalidFieldsNum = $('.input-wrapper.invalid').length;
    mandatoryFields = [emailInput.val(), passwordInput.val(), passwordCheckInput.val()];
    emptyMandatoryFields = $.map(mandatoryFields, function(value) {
      if (value !== "") {
        return value;
      }
    });
    if (invalidFieldsNum > 0 || mandatoryFields.length !== emptyMandatoryFields.length) {
  ...
  passwordInput.keydown(function(event) {
    ...
    return passwordCheckField.fadeIn();
  });
  passwordCheckInput.keydown(function(event) {
    return $('.btn-container.single').removeClass('single');
  });
...
;require.register("reset", function(exports, require, module) {
$(function() {
  var button, errorAlert, passwordInput, submitPassword, successAlert, wait;
