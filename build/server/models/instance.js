...
var CozyInstance, americano, domain, resetKey;
...
CozyInstance.getDomain = function(callback) {
  ...
  return CozyInstance.first(function(err, instance) {
    domain = (instance != null ? instance.domain : void 0) || null;
    return callback(err, domain);
  });
};

CozyInstance.updateDomainCache = function() {
  return CozyInstance.first(function(err, instance) {
    return domain = (instance != null ? instance.domain : void 0) || null;
  });
};
