...
(function() {
  var Client, InstanceManager, LocalStrategy, PasswordKeys, S, StatusChecker, UserManager, bcrypt, configurePassport, express, fs, helpers, httpProxy, middlewares, passport, passwordKeys, qs, randomstring, util,
  ...
  exports.CozyProxy = (function() {
    ...
    function CozyProxy() {
      ...
      this.replication2 = __bind(this.replication2, this);
      ...
      this.setControllers();
      this.couchProxy = require('express-couch-proxy');
      this.couchProxy = this.couchProxy({
        realm: 'CouchDB Replication'
      }, function(database, username, password, next) {
    ...
    CozyProxy.prototype.setControllers = function() {
      ...
      this.app.all('/files/*', this.replication2);
      this.app.all('http://localhost:5984/cozy/', this.replication);
    ...
    */
    ...
    CozyProxy.prototype.replication2 = function(req, res) {
      var buffer;
    ...
    CozyProxy.prototype.defaultRedirectAction = function(req, res) {
      /*@couchProxy {realm: 'CouchDB Replication'}, (database, username, password, next) =>
          console.log 'function'
          if 'test' == username
              return next(null, "http://test:secrets@localhost:5984/" + database)
          else
      ...
      */
      ...
      console.log('defaultRedirectAction');
