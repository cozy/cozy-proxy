...
var apps, auth, devices, disk, experiment, git, index, passport, utils;
...
module.exports = {
  ...
  'repo/:name*': {
    all: [utils.authenticateWithEmail, git.serveRepo]
  },
  'cozy/*': {
  ...
  '*': {
    all: [utils.isAuthenticated, index.defaultRedirect]
  }
};
