module.exports = {
  ...
  "login recover again": "Vous ne l'avez pas reçu ? Renvoyez-le moi.",
  ...
  "login recover error title": "Impossible d'envoyer le message",
  "login recover error message": "Une erreur est survenue lors de l'envoi du message de restauration du mot de passe. Veuillez vérifier que votre serveur peut envoyer des messages, ou contacter son administrateur",
