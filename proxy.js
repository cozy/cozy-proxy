...
var Client, InstanceManager, LocalStrategy, PasswordKeys, StatusChecker, UserManager, bcrypt, configurePassport, express, fs, helpers, httpProxy, middlewares, passport, passwordKeys, qs, randomstring,
...
exports.CozyProxy = (function() {
  ...
  */
  ...
  CozyProxy.prototype.ensureStarted = function(slug, cb) {
    var _this = this;
  ...
  CozyProxy.prototype.redirectAppAction = function(req, res) {
    ...
    return this.ensureStarted(appName, function(err, port) {
      if (err != null) {
