module.exports =
    ...
    'preset timezone tip':       "Vous permet d'afficher correctements les heures dans les événements."
    ...
    'email server':        "serveur imap"
    'email port':          "port"
    'email ssl':           "Utiliser SSL?"
    'email show advanced': "Configurer des paramètres avancés"
    'email username':      "nom d'utilisateur"
    'email username tip':  "Nom d'utilisateur, si différent de l'adresse email du compte."
